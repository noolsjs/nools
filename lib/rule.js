...
var getParamType = function (param) {
    ...
    if (comb.isDefined(param)) {
        if (param === String || param === "string" || param === "?string") {
            ret = String;
        } else if (param === Array || (comb.isArray(param) && param.length == 0) || param === "array") {
            ret = Array;
        } else if (param === Date || param === "date") {
            ret = Date;
        } else if (param === Boolean || param === "boolean") {
            ret = Boolean;
        } else if (param === RegExp || "regexp" === param) {
            ret = RegExp;
        } else if (param === Number || "number" === param) {
            ret = Number;
