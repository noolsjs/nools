...
var ParamPattern = FromPattern.extend({
    instance: {
        constructor: function (type, alias, scope) { 
             ObjectPattern.prototype.constructor.call(this, type, alias, [true, null, 'identifier'], {}, {scope:scope, pattern: 'true'});
             this.from = {
					assert: function() {
		...
		//
		,setParam: function(session, p) { 
			var reteNode = session.getParamNode(this)
				,factId = reteNode.assertParam(p);
			return factId;
		}
    }
}).as(exports, "ParamPattern");
